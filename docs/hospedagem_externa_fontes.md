...
- O Cloudflare R2 oferece franquia mensal de 10 GB de armazenamento, 1 milhão de operações de escrita e 10 milhões de leituras: <https://developers.cloudflare.com/r2/pricing/>.
- Cloudflare Pages mantém ativos estáticos gratuitos e as Functions usam a franquia diária do Workers Free: <https://developers.cloudflare.com/pages/functions/pricing/>.
