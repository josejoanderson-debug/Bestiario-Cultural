...
// As ilustrações originais (artes exclusivas geradas para este projeto) eram
// servidas pelo proxy interno da Manus (/manus-storage/...) e não vieram no
// export do site — não há como recuperá-las automaticamente. Como solução
// funcional e honesta, cada capítulo reaproveita sua própria fotografia
// documental (ver shared/photoLedger.ts) também como ilustração de capa. Para
// usar artes ilustradas próprias, basta trocar os valores abaixo por URLs
// enviadas pelo painel administrativo ou hospedadas em client/public.
const coverArt = photoLedger["bumba-meu-boi"].image;
...
// Ver nota acima sobre `coverArt`: mesma limitação, mesma solução (reaproveita
// a fotografia documental de cada capítulo em vez da ilustração exclusiva
// perdida na migração).
const chapterImages: Record<string, string> = Object.fromEntries(
  Object.entries(photoLedger).map(([slug, entry]) => [slug, entry.image]),
);
...
const documentaryImages: Record<string, string> = {
  "bumba-meu-boi": "/manus-storage/bumba-meu-boi_34c2e09c.jpg", forro: "/manus-storage/forro_8901ecc1.jpg", "coco-de-roda": "/manus-storage/coco-de-roda_e5478b12.jpg", "quadrilha-junina": "/manus-storage/quadrilha-junina_0ddf4bd9.jpg", maracatu: "/manus-storage/maracatu_020caab7.jpg", "cavalo-marinho": "/manus-storage/cavalo-marinho_4da2b290.jpg", "repente-cordel": "/manus-storage/repente-cordel_b381ea3b.webp", "carnaval-de-rua": "/manus-storage/carnaval-de-rua_7f848f59.jpg", fandango: "/manus-storage/fandango_ea14383b.jpg", ciranda: "/manus-storage/ciranda_a30db3fe.jpg", pastoril: "/manus-storage/pastoril_a22f25b4.jpg", reisado: "/manus-storage/reisado_2d47cb8d.jpg", baiao: "/manus-storage/baiao_b94fbf39.jpg", xaxado: "/manus-storage/xaxado_71a11060.jpg", cangaco: "/manus-storage/cangaco_19b956c1.jpg", "artesanato-de-barro": "/manus-storage/artesanato-de-barro_2eaae156.jpg", "renda-renascenca": "/manus-storage/renda-renascenca_b6ac2887.png", "ceramica-de-caruaru": "/manus-storage/ceramica-de-caruaru_bc78edd2.jpg", lapinha: "/manus-storage/lapinha_9999adef.jpg", "festa-de-sao-joao": "/manus-storage/festa-de-sao-joao_57dbc621.webp",
};
...
const licensedDocumentaryImages: Record<string, string> = {
  forro: "/manus-storage/forro-festa-cc-by-sa-2_b1d72f04.jpg", "repente-cordel": "/manus-storage/repente-cordel_c8de79ce.jpg", fandango: "/manus-storage/fandango-cc0_18d69836.jpg", ciranda: "/manus-storage/ciranda_01eb8ef8.jpg", pastoril: "/manus-storage/reisado_e58610c6.jpg", reisado: "/manus-storage/reisado_e58610c6.jpg", baiao: "/manus-storage/baiao-luiz-gonzaga-pd_a4553ff8.png", xaxado: "/manus-storage/xaxado_00165cf9.jpg", cangaco: "/manus-storage/cangaco-vestimenta-cc-by-2_f415966a.jpg", "artesanato-de-barro": "/manus-storage/artesanato-de-barro_ab7de161.jpg", "renda-renascenca": "/manus-storage/renda-renascenca_cd76cef5.jpg", lapinha: "/manus-storage/lapinha_43482360.jpg", "festa-de-sao-joao": "/manus-storage/festa-de-sao-joao_16276d5b.jpg",
};
...
const chapterDetailImages: Record<string, string> = {
  "bumba-meu-boi": "/manus-storage/cultura-bumba-meu-boi-detalhe_1bed8476.webp",
  forro: "/manus-storage/cultura-forro-detalhe_04a8abd6.webp",
  "coco-de-roda": "/manus-storage/cultura-coco-de-roda-detalhe_02d484a4.webp",
  "quadrilha-junina": "/manus-storage/cultura-quadrilha-junina-detalhe_8c7426f4.webp",
  maracatu: "/manus-storage/cultura-maracatu-detalhe_e3abd522.webp",
  "cavalo-marinho": "/manus-storage/cultura-cavalo-marinho-detalhe_6016a5d9.webp",
  "repente-cordel": "/manus-storage/cultura-repente-cordel-detalhe_0d40a9e9.webp",
  "carnaval-de-rua": "/manus-storage/cultura-carnaval-de-rua-detalhe_6fc4bab2.webp",
  fandango: "/manus-storage/cultura-fandango-detalhe_d4482ddf.webp",
  ciranda: "/manus-storage/cultura-ciranda-detalhe_35137b52.webp",
  pastoril: "/manus-storage/cultura-pastoril-detalhe_99581271.webp",
  reisado: "/manus-storage/cultura-reisado-detalhe_58b6c5be.webp",
  baiao: "/manus-storage/cultura-baiao-detalhe_bef1f494.webp",
  xaxado: "/manus-storage/cultura-xaxado-detalhe_971ec384.webp",
  cangaco: "/manus-storage/cultura-cangaco-detalhe_70b1f38e.webp",
  "artesanato-de-barro": "/manus-storage/cultura-artesanato-de-barro-detalhe_156089ed.webp",
  "renda-renascenca": "/manus-storage/cultura-renda-renascenca-detalhe_09351ddd.webp",
  "ceramica-de-caruaru": "/manus-storage/cultura-ceramica-de-caruaru-detalhe_4b823200.webp",
  lapinha: "/manus-storage/cultura-lapinha-detalhe_19d75249.webp",
  "festa-de-sao-joao": "/manus-storage/cultura-festa-de-sao-joao-detalhe_7803fd65.webp",
};
